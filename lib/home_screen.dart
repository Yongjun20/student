        ...
        child: Column(
          children: [
            ...
            GridView.count(
              ...
              children: [
                _buildFeatureBox(Icons.chat_bubble_outline, "AI Chatbot", const Color(0xFF5193B3), const AIChatbotScreen()),
                _buildFeatureBox(Icons.calendar_today, "Classes", const Color(0xFF62C4C3), CalendarScreen()),
                _buildFeatureBox(Icons.mail_outline, "Inbox", const Color.fromARGB(255, 255, 212, 144), const InboxScreen()),
